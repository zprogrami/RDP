...
begin
  ShellExecute(0, nil, 'mstsc', '/v:127.0.0.2 /prompt', nil, SW_SHOW);
//  RDPForm := TRDPForm.Create(Self);
//  RDPForm.RDPmstsc.Width := 640;
//  RDPForm.RDPmstsc.Height := 480;
//  RDPForm.Show;
end;
...
begin
  RDPForm := TRDPForm.Create(Self);
  RDPForm.RDPmstsc.Width := 800;
  RDPForm.RDPmstsc.Height := 600;
  RDPForm.Show;
end;
...
begin
  RDPForm := TRDPForm.Create(Self);
  RDPForm.RDPmstsc.Width := 1024;
  RDPForm.RDPmstsc.Height := 768;
  RDPForm.Show;
end;
...
begin
  RDPForm := TRDPForm.Create(Self);
  RDPForm.RDPmstsc.Width := 1920;
  RDPForm.RDPmstsc.Height := 1080;
  RDPForm.Show
end;
